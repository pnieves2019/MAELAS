...
class MAELAS_Options:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(description='MAELAS code v3.0')
        self.parser.add_argument('-mode', dest='mode', type=int, nargs=1, 
                            default=['2'], 
                            help='-mode 1: Scheme for the direct calculation of the anisotropic magnetostrictive coefficients. -mode 2: Scheme for the direct calculation of the anisotropic magnetoelastic constants. Mode 2 is more accurate for non-cubic symmetries. -mode 3: Scheme for the direct calculation of isotropic magnetoelastic constants (default: 2) ')
        ...
        self.parser.add_argument('-n', dest='ndist', type=int, nargs=1, 
                            default=['7'], 
                            help='Number of distorted states for the direct calculation for each magnetostriction coefficient (-mode 1) or magentoelastic contant (-mode 2 or -mode 3)(default: 7)')
