...
class MAELAS_Options:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(description='MAELAS code v1.0')
        ...
        self.parser.add_argument('-b', dest='delas', action='store_true',
                            default=False,
                            help='Calculation of the magnetoelastic constants from the calculated magnetostriction coefficients and provided elastic tensor. For this option the tag -d must be included as well as tag -e with the elastic tensor file')
