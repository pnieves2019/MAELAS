...
def em0(eexx,eexy,eexz,eeyy,eeyz,eezz,bb21,bb22,bb3,bb4,bbp3,aax,aay,aaz):
    
    ene0 = bb21*(aaz**2.0-(1.0/3.0))*(eexx+eeyy) + bb22*(aaz**2.0-(1.0/3.0))*eezz + bb3*(0.5*(aax**2.0-aay**2.0)*(eexx-eeyy))+2.0*bbp3*aax*aay*eexy
...
for i in range(int(ndist)):
    ...
    em = em0(exx,exy,exz,eyy,eyz,ezz,b21,b22,b3,b4,bp3,ax,ay,az)
