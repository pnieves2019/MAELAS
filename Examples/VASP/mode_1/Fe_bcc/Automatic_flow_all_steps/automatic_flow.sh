...
############################
# step 3: generation VASP input files  (-mode 1)
############################
...
maelas -g -mode 1 -i POSCAR_Fe_bcc_rlx -k 60 -s 0.01 -n 7 -f ${path_cal}/step3 -a OPEN-19-14 -q qprod > output.dat
...
############################
# step 5a: Derivation of anisotropic magnetostriction coefficients (-mode 1)
############################
...
############################
# step 5b: Derivation of magnetoelastic constants (-mode 1)
############################
